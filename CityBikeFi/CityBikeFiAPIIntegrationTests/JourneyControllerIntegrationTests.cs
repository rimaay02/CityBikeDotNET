...
{
    public class JourneyControllerIntegrationTests
    {
        private readonly string _connectionString = "Server=localhost;port=3306; Database=CityBikeTestDb; Uid=root; Pwd=1234";
        private DbContextOptions<CityBikeContext> _options;
        private CityBikeContext? _context;

        public JourneyControllerIntegrationTests()
        {
        ...
        [Fact]
        public async Task GetAllJourneyTest()
        {
            using (MySqlConnection connection = new MySqlConnection(_connectionString))
            {
                ...
                var journeyInfoList = Assert.IsType<List<JourneyView>>(okResult.Value);
                Assert.NotNull(journeyInfoList);
